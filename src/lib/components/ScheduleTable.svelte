<script>
	...
	let wday="Monday", startH = 0, startM = 0, endH = 1, endM = 0;
...
<div class="overflow-x-auto hide-scrollbar" style="margin-top: 0px; margin-left: -24px; margin-right: -24px; margin-bottom: -11px; border-bottom: 0px solid #1f63bb;">
	<table>
